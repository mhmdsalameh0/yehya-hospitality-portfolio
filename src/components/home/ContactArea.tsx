...
export default function ContactArea() {
  ...
  const handleSubmit = (e: any) => {
    ...
    window.open(`https://wa.me/96899178794?text=${encodeURIComponent(whatsappMessage)}`, '_blank');
  };
            ...
            <div className="col-lg-4">
              <div className="contact-content-part  wow fadeInUp delay-0-2s">
                ...
                <div className="single-contact wow fadeInUp" data-wow-delay=".4s">
                  ...
                  <p>Tel: 00961 78701581<br />WhatsApp: 00968 991 787 94</p>
                </div>
                ...
                <div className="single-contact wow fadeInUp" data-wow-delay=".6s">
                  ...
                  <h2>Email Me:</h2>
                  <p><a href="mailto:yehyaabouzahr@gmail.com">yehyaabouzahr@gmail.com</a></p>
                </div>
